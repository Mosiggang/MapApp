...
- 앱 설명: 사용자에게 증강현실(AR) 안내판으로 목적지까지의 도보경로 진행방향을 알려주는 앱

- 개발 계기: 한림대학교 2022년 2학기 소프트웨어 융합대학 캡스톤 디자인 과제물

- 개발 목적: 한국에서도 구글의 AR 지도 서비스와 유사한 AR 도보경로를 사용하면 실용적일 것 같아 개발
